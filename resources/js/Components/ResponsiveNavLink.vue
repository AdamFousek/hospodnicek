...
const classes = computed(() => {
    return props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-sea-pink-400 text-left text-base font-medium text-sea-pink-700 bg-sea-pink-50 focus:outline-none focus:text-sea-pink-800 focus:bg-sea-pink-100 focus:border-sea-pink-700 transition duration-150 ease-in-out'
